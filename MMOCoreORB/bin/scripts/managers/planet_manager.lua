...
naboo = {
	...
	planetTravelPoints = {
		...
		{name = "Iconic Encounter", x = -6475.0, z = 17.2, y = -3642.4, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1},
...
--		{name = "Restuss Shuttleport", x = 5211, z = 80, y = 5791, interplanetaryTravelAllowed = 0, incomingTravelAllowed = 1},
		{name = "Death Watch Stronghold", x = 4861.3, z = 78.2, y = -1034.8, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1},
...
kaas = {
	...
	planetTravelPoints = {
		...
		{name = "a Civilian Starport", x = 2851.0, z = 125.0, y = 3890.0, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1},
	},
