...
-- Mobiles
	...
	spawnMobile("kaas", "rebel_commando_combat_medic", 200, -49.5, -87.8, -146.5, 90, 35791563)
	...
	spawnMobile("kaas", "rebel_commando_bombardier", 200, -81.8, -70.3, -124.4, -90, 35791561)
	spawnMobile("kaas", "rebel_commando_bombardier", 200, -116.1, -69.3, -126.5, 90, 35791561)
	
	spawnMobile("kaas", "rebel_commando_captain", 200, -110.2, -69.7, -170.6, 90, 35791561)
