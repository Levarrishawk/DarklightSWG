...
--Setup
function kaas_introduction:getActivePlayerName()
	return self.questdata.activePlayerName
end

function kaas_introduction:setActivePlayerName(playerName)
...
--Thiels Conv
kaas_introduction_convo_handler = Object:new {
	
 }

function kaas_introduction_convo_handler:getNextConversationScreen(conversationTemplate, conversingPlayer, selectedOption)
...
function kaas_introduction_convo_handler:runScreenHandlers(conversationTemplate, conversingPlayer, conversingNPC, selectedOption, conversationScreen)	
