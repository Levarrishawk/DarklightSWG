blackguard_stormtrooper_squad_leader = Creature:new {
	objectName = "",
	customName = "a Stormtrooper Squad Leader,
...
CreatureTemplates:addCreatureTemplate(blackguard_stormtrooper_squad_leader, "blackguard_stormtrooper_squad_leader")
