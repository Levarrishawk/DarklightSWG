...
carbineernovice = { {"actionshot2",""},{"fullautosingle2",""},{"burstshot1",""} }
pistoleernovice = { {"healthshot2",""},{"pointblanksingle2",""} }
riflemannovice = { {"strafeshot1",""},{"mindshot2",""},{"flushingshot1",""} }
fencernovice = { {"melee1hhit2",""},{"melee1hhealthhit1",""},{"melee1hbodyhit2",""},{"melee1hblindhit1",""} }
swordsmannovice = { {"melee2hhit2",""},{"melee2harea1",""},{"melee2hheadhit2",""},{"melee2hmindhit1",""} }
...
carbineermid = { {"actionshot2",""},{"fullautosingle2",""},{"fullautoarea2",""},{"wildshot1",""},{"chargeshot1",""},{"cripplingshot",""} }
pistoleermid = { {"bodyshot3",""},{"healthshot2",""},{"pointblanksingle2",""} }
riflemanmid = { {"strafeshot1",""},{"mindshot2",""},{"flushingshot2",""},{"startleshot1",""} }
fencermid = { {"melee1hhit2",""},{"melee1hhealthhit1",""},{"melee1hbodyhit3",""},{"melee1hblindhit2",""},{"melee1hdizzyhit2",""},{"melee1hspinattack2",""} }
...
pistoleermaster = { {"healthshot2",""},{"pointblanksingle2",""},{"bodyshot3",""} }
riflemanmaster = { {"strafeshot2",""},{"mindshot2",""},{"flushingshot2",""},{"startleshot2",""} }
fencermaster = { {"melee1hhit3",""},{"melee1hdizzyhit2",""},{"melee1hhealthhit2",""},{"melee1hspinattack2",""},{"melee1hbodyhit2",""},{"melee1hblindhit2",""} }
swordsmanmaster = { {"melee2hhit3",""},{"melee2harea3",""},{"melee2hspinattack2",""} }
