...
object_building_player_player_house_corellia_medium_style_02 = object_building_player_shared_player_house_corellia_medium_style_02:new {
	...
	childObjects = {
			{templateFile = "object/tangible/sign/player/house_address_corellia.iff", x = 5.72, z = 2, y = 7.70, ox = 0, oy = 0.707107, oz = 0, ow = 0.707107, cellid = -1, containmentType = -1},
	...
	shopSigns = {
			{templateFile = "object/tangible/sign/player/house_address_corellia.iff", x = 5.72, z = 2, y = 7.70, ox = 0, oy = 0.707107, oz = 0, ow = 0.707107, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:house_address"},				
