...
#ifndef UNARMEDWARCRYCOMMAND_H_
#define UNARMEDWARCRYCOMMAND_H_
...
class UnarmedWarcryCommand : public CombatQueueCommand {
public:

	UnarmedWarcryCommand(const String& name, ZoneProcessServer* server)
