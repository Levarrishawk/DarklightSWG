...
#ifndef UNARMEDINTIMIDATECOMMAND_H_
#define UNARMEDINTIMIDATECOMMAND_H_
...
class UnarmedIntimidateCommand : public CombatQueueCommand {
public:

	UnarmedIntimidateCommand(const String& name, ZoneProcessServer* server)
...
#endif //UNARMEDINTIMIDATECOMMAND_H_
