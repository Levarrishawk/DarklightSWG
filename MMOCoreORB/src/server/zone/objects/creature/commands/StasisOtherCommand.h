...
#ifndef STASISOTHERCOMMAND_H_
#define STASISOTHERCOMMAND_H_

#include "server/zone/objects/scene/SceneObject.h"
#include "server/zone/managers/combat/CombatManager.h"
#include "CombatQueueCommand.h"

class StasisOtherCommand : public CombatQueueCommand {
public:

	StasisOtherCommand(const String& name, ZoneProcessServer* server)
