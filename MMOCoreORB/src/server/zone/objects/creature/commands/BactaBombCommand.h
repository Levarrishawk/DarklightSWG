...
#ifndef BACTABOMBCOMMAND_H_
#define BACTABOMBCOMMAND_H_

#include "server/zone/objects/scene/SceneObject.h"
#include "server/zone/managers/combat/CombatManager.h"
#include "CombatQueueCommand.h"

class BactaBombCommand : public CombatQueueCommand {
	int mindCost;
	int mindWoundCost;
...
public:
	...
	BactaBombCommand(const String& name, ZoneProcessServer* server)
	...
	int doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) {
		...
		int healPower = (creature->getSkillMod("combat_healing_ability") * 15);
